...
#> 2 c     Floor       Baseline KPI level at zero spend…  7.45e+1  6.15e+1  8.73e+1
#> 3 d     Ceiling     Maximum achievable KPI at satura…  9.48e+2  9.36e+2  9.63e+2
#> 4 e     Midpoint    Spend level at the inflection po…  4.20e+4  4.18e+4  4.22e+4
```
...
#> b_Intercept    -9.73      0.20    -9.99    -9.24 1.00      346      336
#> c_Intercept     0.03      0.01     0.02     0.05 1.00      399      525
#> d_Intercept     0.99      0.01     0.97     1.00 1.00      452      562
#> e_Intercept     0.47      0.00     0.46     0.47 1.00      449      385
#> 
#> Further Distributional Parameters:
#>       Estimate Est.Error l-95% CI u-95% CI Rhat Bulk_ESS Tail_ESS
#> sigma     0.03      0.00     0.02     0.03 1.00      732      722
#> 
...
#>   Paid Social            $31,196           529         $59   15.2%
#>   Paid Search            $51,532           825         $62   25.2%
#>   Online Video           $38,130           595         $64   18.6%
#>   Display                $19,517           288         $68    9.5%
#>   TV                     $64,267           699         $92   31.4%
#> -- Totals -------------------------------------------------------------------- 
#>   Optimal:  Spend $204,641  |  KPI 2,936  |  Avg CP $70
#>   Current:  Spend $204,641  |  KPI 2,754  |  Avg CP $74
#>   Change:   KPI +6.6%  |  CP $5
```
...
#> 1 Paid Soci…        27082         31196.      0.152             390.        529.
#> 2 Paid Sear…        45395.        51532.      0.135             595.        825.
#> 3 Online Vi…        33829.        38130.      0.127             471.        595.
#> 4 Display           17581.        19517.      0.110             220.        288.
#> 5 TV                80753.        64267.     -0.204            1079.        699.
#> 6 TOTAL            204641.       204641       0.00000216       2754.       2936.
...
#>   Paid Social            $31,211     [$30,757 – $31,803]         $59  +15.2%
#>   Paid Search            $51,581     [$51,182 – $52,012]         $62  +25.2%
#>   Online Video           $38,161     [$37,470 – $39,032]         $64  +18.6%
#>   Display                $19,540     [$19,252 – $19,824]         $68   +9.5%
#>   TV                     $64,193     [$62,235 – $65,661]         $92  +31.4%
#> -- Totals -------------------------------------------------------------------- 
#>   Optimal:  Spend $204,686  |  KPI 2,936  |  Avg CP $70
#>   Current:  Spend $204,641  |  KPI 2,754  |  Avg CP $74
#>   Change:   KPI +6.6%  |  CP $5
```
...
#> 
#> Optimization converged (status: 4 )
#> Total weekly KPI: 4,593 
#> Total period KPI: 238,852
```
