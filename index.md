...
The workflow spans data input through allocation decision. See the
[Workflow Overview](https://bdshaff.github.io/mrmopt/workflow.html)
vignette for the full diagram and walkthrough.
